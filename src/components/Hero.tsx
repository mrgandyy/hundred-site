export default function Hero() {
  return (
    <section id="home" className="relative overflow-hidden">
      {/* Moving glow blobs (behind, non-interactive) */}
      <div className="pointer-events-none absolute inset-0 -z-10 opacity-25">
        <div className="absolute -top-24 -right-16 h-[34rem] w-[34rem] rounded-full bg-accent-500 blur-3xl animate-blob" />
        <div className="absolute -bottom-24 -left-24 h-[30rem] w-[30rem] rounded-full bg-ice blur-3xl opacity-70 animate-blob animation-delay-2000" />
        <div className="absolute top-1/2 left-1/3 h-[22rem] w-[22rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-accent-600 blur-3xl opacity-40 animate-blob animation-delay-4000" />
      </div>
  ...
  We don’t do 99. <span className="text-accent-400 drop-shadow">We keep it 100.</span>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                ...
                target="_blank"
                className="btn-sheen px-6 py-3 rounded-2xl bg-accent-500 text-black font-bold shadow-glow hover:-translate-y-0.5 transition"
              >
                Join the Discord
              </a>
              <a
          ...
          {/* Video with animated gradient ring */}
          <div className="relative z-10">
            <div className="ring-animate rounded-2xl p-[1px]">
              <div className="aspect-video rounded-2xl border border-white/10 bg-base-800/70 backdrop-blur-sm overflow-hidden shadow-xl">
                <iframe
                  ...
                  src="https://www.youtube.com/embed/LP_YGLhiT4o?rel=0&modestbranding=1"
                  title="Promo"
